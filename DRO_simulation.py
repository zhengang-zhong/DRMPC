...
class Simulation:
    ...
    def __init__(self, model, Q, Qf, R, x_init, beta = 0.95, beta_prob = 0.95, N_sample = 10, i_th_state = 1, i_state_ub = 0.05, epsilon = 1,
    ...
    def simulation_collect(self,x_init,N_sim, data_set, N_sample_max, est):
        ...
        for i in range(N_sim):
            ...
            opt_problem = Opt_problem(self.model, Q, Qf, R, beta=beta, beta_prob = beta_prob, N_sample=N_sample, i_th_state=i_th_state,
